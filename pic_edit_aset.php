<?php
	...
	get_header();
	get_sidebar();
	get_breadkemaskiniaset();
  date_default_timezone_set("Asia/Kuala_Lumpur") ;
  $currentdate=date('F j,Y');

  $item=$_GET['picedit_invent'];
					...
					<div class="box-content">
						...
						<form class="form-horizontal" method="post" action="proses.php">
							...
							<div class="control-group">
								<div class="controls">
									<input class="input-xlarge focused" id="focusedInput" type="hidden" name="id" value="<?php echo $row['id_rekod']; ?>">
								</div>
							 </div>
							...
							<div class="controls">
							 	<div>
								  <input  name="n_makmal" type="hidden" value="<?php echo $n_makmal; ?>">
								</div>
							</div>

							  <div class="form-actions">
								<button type="submit" onclick="return confirmAdd()" class="btn btn-primary" name="picupdate_invent" value="<?php echo $item?>">Kemaskini</button>
							  </div>
							</fieldset>
						</form>
						<?php } ?>
