	...
	<!--<li>
		...
		<i class="icon-angle-right"></i>
		<li><a href="j_penggunaan.php">Jadual Penggunaan</a></li>
	</ul>
...
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Jadual Penggunaan Makmal</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							$sql="SELECT * FROM penggunaan WHERE g_bertugas = '$pengguna'";
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="edit_penggunaan.php?editpenggunaan=<?php echo $row['id_penggunaan']; ?>">
